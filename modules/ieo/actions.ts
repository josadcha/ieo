...
export interface ReleaseIEOFetch {
    type: typeof IEO_RELEASE_FETCH;
    payload: {
        id: number | string;
        release_fund: string | number;
    };
}

export interface ReleaseIEOData {
    type: typeof IEO_RELEASE_DATA;
}

export interface ReleaseIEOError {
    type: typeof IEO_RELEASE_ERROR;
}
...
export const releaseIEO = (
    payload: ReleaseIEOFetch['payload'],
): ReleaseIEOFetch => ({
    type: IEO_RELEASE_FETCH,
    payload,
});

export const releaseIEOData =  (): ReleaseIEOData => ({
    type: IEO_RELEASE_DATA,
});

export const releaseIEOError = (): ReleaseIEOError => ({
    type: IEO_RELEASE_ERROR,
});
